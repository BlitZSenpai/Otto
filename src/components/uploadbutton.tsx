...
const UploadDropzone = ({ isSubscribed }: { isSubscribed: boolean }) => {
  ...
  const [uploadPorgress, setUploadProgress] = useState(0);
  ...
  const { startUpload } = useUploadThing(!isSubscribed ? "freePlanUploader" : "proPlanUploader");
            ...
            <label
              ...
              {isUploading ? (
                <div className="w-full mt-4 max-w-xs mx-auto">
                  <Progress
                    indicatorColor={uploadPorgress === 100 ? "bg-green-500" : ""}
                    value={uploadPorgress}
                    className="h-1 w-full text-blue-600 bg-zinc-200"
                  />
                  {uploadPorgress === 100 ? (
